...
if (typeof HomePageAPI !== 'undefined') {
  console.warn('HomePageAPI already declared, skipping...');
} else {
  class HomePageAPI {
    constructor() {
      this.init();
    ...
    async refreshStats(event) {
      ...
      try {
        ...
        // TODO: When API endpoint exists, use AJAX instead
        setTimeout(() => {
    ...
    handleQuickAction(event) {
      ...
      switch (action) {
        ...
        case 'view-adoptions':
          ...
          break;
        case 'add-pet':
          // TODO: Redirect to add pet form when created
...
} // End of HomePageAPI class definition protection
